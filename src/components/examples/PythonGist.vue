<template><div id="gist102445871" class="gist">
    <div class="gist-file">
      <div class="gist-data">
        <div class="js-gist-file-update-container js-task-list-container file-box">
  <div id="file-python-py" class="file">
  <div itemprop="text" class="Box-body p-0 blob-wrapper data type-python ">

<table class="highlight tab-size js-file-line-container" data-tab-size="8" data-paste-markdown-skip>
      <tr>
        <td id="file-python-py-L1" class="blob-num js-line-number" data-line-number="1"></td>
        <td id="file-python-py-LC1" class="blob-code blob-code-inner js-file-line"><span class=pl-s>&quot;&quot;&quot;</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="file-python-py-LC2" class="blob-code blob-code-inner js-file-line"><span class=pl-s>Xend Mail API python sending Email Example</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="file-python-py-LC3" class="blob-code blob-code-inner js-file-line"><span class=pl-s>&quot;&quot;&quot;</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="file-python-py-LC4" class="blob-code blob-code-inner js-file-line"><span class=pl-k>import</span> <span class=pl-s1>requests</span>,<span class=pl-s1>json</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="file-python-py-LC5" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="file-python-py-LC6" class="blob-code blob-code-inner js-file-line"><span class=pl-c># the API endpoint</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="file-python-py-LC7" class="blob-code blob-code-inner js-file-line"><span class=pl-s1>url</span> <span class=pl-c1>=</span> <span class=pl-s>&quot;https://sendmail.azuatech.co.ke/api/send&quot;</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="file-python-py-LC8" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="file-python-py-LC9" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="file-python-py-LC10" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="file-python-py-LC11" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="file-python-py-LC12" class="blob-code blob-code-inner js-file-line"><span class=pl-c># The email data to send</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="file-python-py-LC13" class="blob-code blob-code-inner js-file-line"><span class=pl-s1>email_data</span> <span class=pl-c1>=</span> {</td>
      </tr>
      <tr>
        <td id="file-python-py-L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="file-python-py-LC14" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&quot;name&quot;</span> :<span class=pl-s>&quot;Email Sender Name&quot;</span>,</td>
      </tr>
      <tr>
        <td id="file-python-py-L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="file-python-py-LC15" class="blob-code blob-code-inner js-file-line"><span class=pl-s>&quot;from&quot;</span>: <span class=pl-s>&quot;test@example.com&quot;</span>,</td>
      </tr>
      <tr>
        <td id="file-python-py-L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="file-python-py-LC16" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&quot;to&quot;</span> : [<span class=pl-s>&#39;test1@example.com&#39;</span>],</td>
      </tr>
      <tr>
        <td id="file-python-py-L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="file-python-py-LC17" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&quot;subject&quot;</span>: <span class=pl-s>&quot;Xend Mail API sending Email Example&quot;</span>,</td>
      </tr>
      <tr>
        <td id="file-python-py-L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="file-python-py-LC18" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&quot;cc&quot;</span> : [<span class=pl-s>&#39;test2@example.com&#39;</span>,<span class=pl-s>&quot;test3@example.com&quot;</span>],</td>
      </tr>
      <tr>
        <td id="file-python-py-L19" class="blob-num js-line-number" data-line-number="19"></td>
        <td id="file-python-py-LC19" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&quot;bcc&quot;</span>: [<span class=pl-s>&#39;test#test.com&#39;</span>,<span class=pl-s>&#39;test1@example.com&#39;</span>],</td>
      </tr>
      <tr>
        <td id="file-python-py-L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="file-python-py-LC20" class="blob-code blob-code-inner js-file-line"><span class=pl-s>&quot;body&quot;</span>: <span class=pl-s>&quot;&lt;p style=&#39;color:red&#39;&gt;Xend Mail API sending email example using Python&lt;/p&gt;&quot;</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="file-python-py-LC21" class="blob-code blob-code-inner js-file-line">}</td>
      </tr>
      <tr>
        <td id="file-python-py-L22" class="blob-num js-line-number" data-line-number="22"></td>
        <td id="file-python-py-LC22" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L23" class="blob-num js-line-number" data-line-number="23"></td>
        <td id="file-python-py-LC23" class="blob-code blob-code-inner js-file-line"><span class=pl-c># The HTTP headers for the request</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L24" class="blob-num js-line-number" data-line-number="24"></td>
        <td id="file-python-py-LC24" class="blob-code blob-code-inner js-file-line"><span class=pl-s1>headers</span> <span class=pl-c1>=</span> {</td>
      </tr>
      <tr>
        <td id="file-python-py-L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="file-python-py-LC25" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&quot;Content-type&quot;</span>: <span class=pl-s>&quot;application/json&quot;</span>,</td>
      </tr>
      <tr>
        <td id="file-python-py-L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="file-python-py-LC26" class="blob-code blob-code-inner js-file-line">    <span class=pl-s>&#39;X-Api-Key&#39;</span> : <span class=pl-s>&#39;YOUR-API-KEY-HERE&#39;</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="file-python-py-LC27" class="blob-code blob-code-inner js-file-line">    } </td>
      </tr>
      <tr>
        <td id="file-python-py-L28" class="blob-num js-line-number" data-line-number="28"></td>
        <td id="file-python-py-LC28" class="blob-code blob-code-inner js-file-line"><span class=pl-c># Sending the POST HTTP request to the API endpoint and getting the result</span></td>
      </tr>
      <tr>
        <td id="file-python-py-L29" class="blob-num js-line-number" data-line-number="29"></td>
        <td id="file-python-py-LC29" class="blob-code blob-code-inner js-file-line"><span class=pl-s1>x</span> <span class=pl-c1>=</span> <span class=pl-s1>requests</span>.<span class=pl-en>post</span>(<span class=pl-s1>url</span>, <span class=pl-s1>data</span><span class=pl-c1>=</span><span class=pl-s1>json</span>.<span class=pl-en>dumps</span>(<span class=pl-s1>email_data</span>) ,<span class=pl-s1>headers</span><span class=pl-c1>=</span><span class=pl-s1>headers</span>)</td>
      </tr>
      <tr>
        <td id="file-python-py-L30" class="blob-num js-line-number" data-line-number="30"></td>
        <td id="file-python-py-LC30" class="blob-code blob-code-inner js-file-line">
</td>
      </tr>
      <tr>
        <td id="file-python-py-L31" class="blob-num js-line-number" data-line-number="31"></td>
        <td id="file-python-py-LC31" class="blob-code blob-code-inner js-file-line"><span class=pl-en>print</span>(<span class=pl-s1>x</span>.<span class=pl-s1>text</span>)</td>
      </tr>
</table>
      ...
      <div class="gist-meta">
        <a href="https://gist.github.com/cetric32/bdfc0929c664d6a3a44ef8a051b189b4/raw/0d5bdd78679a3a092a8dfc51f466f4c239d7b5a5/python.py" style="float:right">view raw</a>
        <a href="https://gist.github.com/cetric32/bdfc0929c664d6a3a44ef8a051b189b4#file-python-py">python.py</a>
